...
export const createCheckoutSession = async (req, res) => {
   ...
   try {
      ...
      // checks if products is an array or not empty
      ...
      const session = await stripe.checkout.sessions.create({
         ...
         mode: 'payment',
         success_url: `${process.env.USER_URL}/purchase-success?session_id={CHECKOUT_SESSION_ID}`,
         cancel_url: `${process.env.USER_URL}//purchase-cancel`,
         discounts: coupon
         ? [
            {
