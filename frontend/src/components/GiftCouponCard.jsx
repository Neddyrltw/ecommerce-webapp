    ...
    <motion.div
      ...
      <div className='space-y-4'>
        <div>
          ...
          <input
            type='text'
            id='voucher'
            className='block w-full rounded-lg border-gray-600 bg-gray-700 p-2.5 text-sm text-white
      ...
      {coupon && isCouponApplied && (
        <div className='mt-4'>
          ...
          <motion.button
            type='button'
            className='mt-2 flex w-full items-center justify-center rounded-lg bg-red-600 ox-5 py-2.5 text-sm
